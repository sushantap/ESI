	...
	public static Article getArticle2() throws InterruptedException{
		...
		return new Article("Comic book targets children in slums",
				"There are no superheroes in this comic book. There is no "+ 
						...
						"living in slums; to stay away from tobacco and alcohol, to know bad "+
						"touch and to keep the environment clean, among others. Reach "+
						"out! With Veera and Chera  a comic book with seven episodes in "+
						"it, by Loyola College student Vijay Asokan, was released at the "+
						"Outreach Day2014 celebrations of the colleges department of "+
						...
						"cities. Children in slums do not know the serious problems in life. "+
